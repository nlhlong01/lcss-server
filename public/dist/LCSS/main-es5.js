...
var AllGamesComponent = /** @class */ (function () {
    function AllGamesComponent(fetchDataService) {
...
var FecthDataService = /** @class */ (function () {
    function FecthDataService(http) {
        this.http = http;
    }
    FecthDataService.prototype.getAllGames = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.http.get('http://35.246.141.86:5000/api/games', { headers: headers }).toPromise()];
                    case 1:
                        data = _a.sent();
    ...
    FecthDataService.prototype.getGame = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                        headers = headers.append('Access-Control-Allow-Origin', '*');
                        return [4 /*yield*/, this.http.get("http://35.246.141.86:5000/api/games/" + id, { headers: headers }).toPromise()];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data];
                }
    ...
    FecthDataService.prototype.postComment = function (id, comment) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers, postObject, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                        ...
                        return [4 /*yield*/, this.http.put("http://35.246.141.86:5000/api/games/" + id, postObject).toPromise()];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data];
                }
    ...
    FecthDataService.prototype.postRating = function (id, rating) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers, postObject, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
var CommentComponent = /** @class */ (function () {
    ...
    CommentComponent.prototype.postComment = function (comment) {
        var _this = this;
        console.log(this.comments);
        this.service.postComment(this.gameId, comment)
            .then(function (data) {
            if (_this.comments === null || _this.comments === undefined) {
                _this.comments = [];
            }
            console.log(data);
            // push to update
...
var GameComponent = /** @class */ (function () {
    function GameComponent(route, router, fetchGame) {
        this.route = route;
        this.router = router;
    ...
    GameComponent.prototype.ngOnInit = function () {
        ...
        if (this.game === undefined) {
            ...
            this.fetchGame.getGame(id).then(function (game) {
                _this.id = game[0]['id'];
                _this.name = game[0]['name'];
                _this.description = game[0]['description'];
                _this.comments = game[0]['comment'];
                _this.image = game[0]['id'];
                _this.rate = game[0]['rate'];
            });
        }
        else {
...
var RatingComponent = /** @class */ (function () {
    function RatingComponent(service) {
        this.service = service;
    }
    RatingComponent.prototype.ngOnInit = function () {
    };
    RatingComponent.prototype.color = function (id) {
    ...
    RatingComponent.prototype.changeColor = function (id) {
        this.fakeRate = id;
    };
    RatingComponent.prototype.resetColor = function () {
        this.fakeRate = null;
    };
    RatingComponent.prototype.onClick = function (event) {
        var _this = this;
        if (this.gameId !== undefined) {
            this.service.postRating(this.gameId, this.fakeRate)
                .then(function (res) {
                console.log(res);
                _this.rate = _this.fakeRate;
            });
        }
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
