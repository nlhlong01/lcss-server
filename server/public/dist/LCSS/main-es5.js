...
module.exports = "\r\n<div>\r\n  <div class=\"col-xs-6 col-md-3\">\r\n    <div class=\"thumbnail\" style=\"width: 100%;\">\r\n      <img *ngIf=\"(image + 1) % 4 == 1\" src=\"../../assets/PUBG.jpg\">\r\n      <img *ngIf=\"(image + 1) % 4 == 2\" src=\"../../assets/mario.jpg\">\r\n      <img *ngIf=\"(image + 1) % 4 == 3\" src=\"../../assets/fifa.jpg\">\r\n      <img *ngIf=\"(image + 1) % 4 == 0\" src=\"../../assets/mario.jpg\">\r\n      <div class=\"caption\">\r\n        <h3>{{ name }}</h3>\r\n        <p>{{ description }}</p>\r\n        <p>\r\n          <a href=\"#\" class=\"btn btn-primary\" role=\"button\" style=\"margin-right: 10px;\">Play game</a> \r\n          <a href=\"#\" class=\"btn btn-default\" role=\"button\">Read more</a>\r\n        </p>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(fetchDataService) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.fetchDataService.getData()
            ...
            catch(function (error) { return _this.games = [
            {
                'name': 'Error',
                'description': 'error'
            }
...
var FecthDataService = /** @class */ (function () {
    ...
    FecthDataService.prototype.getData = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.http.get('http://localhost:5000/api/games', { headers: headers }).toPromise()];
                    case 1:
                        data = _a.sent();
